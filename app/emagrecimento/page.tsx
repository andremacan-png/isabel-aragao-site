...
// Atribuição sutil de origem (só a clínica percebe): "site da Dra. Isabel Aragão" (nome completo) = /emagrecimento
const WA = 'https://wa.me/5548991593468?text=Ol%C3%A1%2C%20vim%20do%20site%20da%20Dra.%20Isabel%20Arag%C3%A3o%20e%20gostaria%20de%20saber%20mais%20sobre%20agendamento%20de%20consulta'
  ...
  return (
    <div className="min-h-screen bg-[#F7F3EF] font-sans">
      ...
      <nav className="bg-[#12082a] sticky top-0 z-50">
        ...
        <AnchorBar links={[
          { href: '#reframe', label: 'Por que o corpo resiste' },
          { href: '#tratamento', label: 'O tratamento' },
      ...
      {/* O sinal que faltava */}
      <section id="tratamento" className="py-20 px-4 sm:px-6 bg-[#12082a] text-white">
        <div className="max-w-3xl mx-auto">
      ...
      {/* FAQ */}
      <section id="duvidas" className="py-16 px-4 sm:px-6 bg-white">
        <div className="max-w-3xl mx-auto">
      ...
      <a href={WA} target="_blank" rel="noopener noreferrer"
        ...
        <span className="text-sm font-medium hidden sm:inline">Falar com a equipe</span>
      </a>
    </div>
  )
}
